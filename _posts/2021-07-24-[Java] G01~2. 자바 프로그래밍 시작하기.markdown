...
<br/>
index<br/>
<a herf="#JVM">JVM(Java Virtual Machine)</a><br/>
<a herf="#SDT">SDT(Strict Data Type)</a><br/>
<a herf="#Garbage Collector">Garbage Collector</a><br/>
<a herf="#POP">POP (Procedure Oriented Program)</a><br/>
<a herf="#OOP">OOP(Object Oriented Program)</a><br/>
