...
<br/>
<a id="#JVM">JVM(Java Virtual Machine)</a><br/>
<a id="#SDT">SDT(Strict Data Type)</a><br/>
<a id="#Garbage Collector">Garbage Collector</a><br/>
<a id="#POP">POP (Procedure Oriented Program)</a><br/>
<a id="#OOP">OOP(Object Oriented Program)</a><br/>
<br/>
